...
TREATMENTS = {
    ...
    "Common Rust": [
        "Gunakan fungisida mankozeb atau propikonazol",
    ...
    "Blight": [
        ...
        "Bersihkan sisa tanaman yang terinfeksi"
    ]
}
...
def preprocess_image(img):
    ...
    img = np.array(img)
    img = preprocess_input(img)   # WAJIB UNTUK MOBILENETV2
...
def home_page():
    ...
    ### 📌 Cara Penggunaan
    1. Buka tab **Kamera**
    2. Ambil gambar atau upload foto daun jagung
...
def camera_page():
    ...
    if image:
        ...
        if conf < 0.60:
            st.warning(
                "⚠️ Model tidak yakin dengan hasil prediksi. "
            ...
            st.subheader("🛠️ Cara Penanggulangan")
...
# =======================
def example_page():
    st.title("🖼️ Contoh Penyakit Daun Jagung")
...
def about_page():
    ...
    **deteksi dini penyakit daun jagung** menggunakan AI.
